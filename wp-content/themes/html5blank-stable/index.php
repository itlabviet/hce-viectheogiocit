	...
	<main id="main">
		 <section id="car_main">
				...
				<div class="t_main">
					...
					<div>
						<button type="button" class="btn btn-primary btn-lg">Tuyển giúp việc theo giờ</button>
						<button type="button" class="btn btn-secondary btn-lg">Tìm việc làm</button>
						<button type="button" class="btn btn-primary btn-lg">Tuyển lao động thời vụ</button>
					</div>
				</div>
		  </section>
