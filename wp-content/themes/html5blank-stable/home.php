		...
		<section id="car_main">
			...
			<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					...
					<img class="d-block w-100" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/carousel/1.jpg" alt="First slide">
					</div>
					<div class="carousel-item">
					<img class="d-block w-100" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/carousel/2.jpg" alt="Second slide">
					</div>
					<div class="carousel-item">
					<img class="d-block w-100" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/carousel/3.jpg" alt="Third slide">
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg img_intro">
						<img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/C-IT.jpg">
					</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-3 img_staff">
						<div class="card">
						  <img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/member/md.jpg" style="width: 100%";>
					...
					<div class="col-sm-3 img_staff">
						<div class="card">
						  <img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/member/huy.jpg" style="width: 100%";>
						  <div class="con_imgstaff">
					  	 	<div class="text_cistaff">
					...
					<div class="col-sm-3 img_staff">
						<div class="card">
						  <img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/member/t.jpg" style="width: 100%";>
						  <div class="con_imgstaff">
						  	 	<div class="text_cistaff">
					...
					<div class="col-sm-3  img_staff">
						<div class="card">
  							<img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/member/kn.jpg" style="width: 100%";>
							<div class="con_imgstaff">
								<div class="text_cistaff">
